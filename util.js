...
// @todo Verificar se declarar o F dessa maneira impede a variável global
let F;

// @todo Trocar module.exports = F = { por apenas module.exports = {, pois F fica declarado em variável global
module.exports = F = {
    ...
    pagedSocketResponse(socket, label, table, allRows, opts){
        ...
        let next = function(){
            ...
            let rows = F.pagedArray(page, perPage, allRows);
    ...
    getFiles(){
        ...
        console.log('global.helpers.f.getFiles');
    ...
    saveLastMod(){
        ...
        F.getFiles().then(files => {
            ...
            Promise.all(stateProm).then(() => {
                ...
                console.log('@todo Salvar statList em .logs, para que seja possível ver gráficos de evolução dos arquivos');
    ...
    assetsChecksum(){
        ...
        return F.getAssets().then(assets => {
